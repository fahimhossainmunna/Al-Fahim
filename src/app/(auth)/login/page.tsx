  ...
  return (
    <div className="group relative space-y-1.5">
      <div className="flex items-center justify-between">
        <label className="text-[9px] uppercase font-sans font-medium tracking-[0.22em] text-neutral-400 group-focus-within:text-black dark:group-focus-within:text-white transition-colors">
          {label}
        </label>
        {extra}
      </div>
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Auth integration logic goes here
      ...
      <div className="hidden lg:flex lg:w-[42%] relative bg-black text-white flex-col justify-between px-14 py-14 overflow-hidden border-r border-white/10">
        ...
        >
          ...
          <p className="font-serif text-3xl leading-[1.3] max-w-sm font-light">
            Secure access to your account, orders, and private appointments.
          </p>
          <div className="w-10 h-px bg-white/20" />
          <p className="text-[11px] text-neutral-500 leading-relaxed max-w-xs">
            Client credentials are required for entry. Registration is by
            verification only.
          </p>
        </motion.div>
        ...
        >
          ...
          <motion.div variants={item} className="space-y-3">
            ...
            <p className="text-[13px] text-neutral-500 dark:text-neutral-400 leading-relaxed max-w-xs">
              Enter your credentials to access your private atelier account.
            </p>
          </motion.div>
                ...
                <Field
                  ...
                  extra={
                    <Link
                      ...
                      className="text-[9px] font-sans tracking-widest uppercase text-neutral-400 hover:text-black dark:hover:text-white transition-colors"
                    >
                      Forgot?
                    </Link>
                  }
